        ...
        <View style={styles.item_box}>
          <View style={styles.item_box_top}>
            <View style={styles.item1}>
              <Image source={require("poketpo2/assets/images/item1.png")} />
            </View>
          </View>
          <View style={styles.item_box_bottom}>
            <View style={styles.item2}>
              <Image source={require("poketpo2/assets/images/item2.png")} />
            </View>
            <View style={styles.item3}>
              <Image source={require("poketpo2/assets/images/item3.png")} />
            </View>
          </View>
        </View>
